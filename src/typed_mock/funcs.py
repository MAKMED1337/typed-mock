...
class ProducerBuilder[**P, R]:
    ...
    def return_once(self, value: R) -> 'ProducerBuilder[P, R]':
        self.fake_method.add_producer(return_once_impl(value))
        return self

    def return_forever(self, value: R) -> 'ProducerBuilder[P, R]':
        self.fake_method.add_producer(return_forever_impl(value))
        return self

    def raise_once[E: BaseException](self, error: E | type[E]) -> 'ProducerBuilder[P, R]':
        self.fake_method.add_producer(raise_once_impl(error))
        return self

    def raise_forever[E: BaseException](self, error: E | type[E]) -> 'ProducerBuilder[P, R]':
        self.fake_method.add_producer(raise_forever_impl(error))
        return self
